    ...
    <div className="h-screen w-screen bg-[#FAFAFA]">
      ...
      <header className="m-[16px] mb-[24px]">
        <div id="profile" className="flex">
          <img src="https://avatars.githubusercontent.com/isaacdigs" className="mr-9 rounded-full w-[77px] h-[77px] sm:h-[150px] sm:w-[150px] border" alt="main profile" />
          <section id="profileCombo" className="flex flex-col justify-center">
            <div id="idGroup" className="flex flex-row mb-2">
            ...
            <div id="buttonGroup" className="flex flex-row">
            ...
            <div id="captionGroup" className="flex flex-col">
              <p id="name" className="font-medium">정이삭</p>
            </div>
          </section>
        </div>
      </header>
